      ...
      <div className='w-full h-full'>
        <div className='absolute w-full h-[550px] bg-gradient-to-r from-black'></div>
          ...
          <div className='absolute w-full top-[20%] p-4 md:p-8'>
            ...
            <div className='my-4'>
              <button type="button" className="border bg-gray-300 text-black border-gray-300 py-2 px-5">Play</button>
              <button type="button" className="border text-white border-gray-300 py-2 px-5 ml-4">Watch Later</button>
            </div>
